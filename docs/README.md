...
| **[05_groq_token_limits_and_solutions.md](file:///docs/05_groq_token_limits_and_solutions.md)** | **Groq Token Limits & 4 Solutions** | Deep dive into Groq's 8,000 TPM limit, root causes, immediate mitigations, and 4 production-grade architectural solutions (Semantic RAG, Pre-summarization, Function Calling, Hybrid Local/Cloud). |
